...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Modification d'une caisse</h5>
        ...
        @endif
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputText" name="codcais" value="{{ $caisse->codcais }}">
              </div>
            </div>
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-4 col-form-label">Libellé caisse</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputEmail" name="libcais" value="{{ $caisse->libcais }}">
              </div>
            </div>
            <div class="text-end">
