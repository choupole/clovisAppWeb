...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Création d'une direction</h5>
        ...
        @endif
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputText" name="coddir">
              </div>
            </div>
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-4 col-form-label">Libellé direction</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputEmail" name="libdir">
              </div>
            </div>
            <div class="text-end">
