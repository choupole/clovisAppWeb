        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form id="delete-form-{{ $document->ndoc }}" action="{{ route('documents.destroy', $document->ndoc) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Modification d'un document</h5>
        ...
        @endif
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-4 col-form-label">Libellé document</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputText" name="libdoc" value="{{ $document->libdoc }}">
              </div>
            </div>
            <div class="row mb-3">
                <label for="inputEmail" class="col-sm-4 col-form-label">Type de document</label>
                <div class="col-sm-8">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <input type="date" class="form-control" id="inputEmail" name="datdoc" value="{{ $document->datdoc }}">
              </div>
            </div>
            <div class="text-end">
