...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Modification d'une fiche de paie</h5>
            ...
            @endif
            <form action="{{ route('paies.update', $paie)}}" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <select class="form-select" id="inputEmail" name="nens">
                            @foreach ($enseignants as $enseignant)
                                <option value="{{ $enseignant->nens }}">{{ $enseignant->nom }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputText" name="mont" value="{{ $paie->mont }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Date paiement</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputText" name="datpaie" value="{{ $paie->datpaie }}">
                    </div>
                </div>
                <div class="row mb-3">
