            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('prestations.edit', $prestation)}}" class="text-success">
...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Création d'une prestation</h5>
        ...
        @endif
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputEmail" name="libprest">
              </div>
            </div>
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-4 col-form-label">Date prestation</label>
                <div class="col-sm-8">
                  <input type="date" class="form-control" id="inputEmail" name="datprest">
                </div>
              </div>
            <div class="text-end">
