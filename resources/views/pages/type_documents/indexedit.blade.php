...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Modification d'un type de document</h5>

          <!-- Horizontal Form -->
          <form action="{{ route('type_documents.update', $type_document) }}" method="POST">
            @csrf
            @method('PUT')
        ...
        @endif
          <div class="row mb-3">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="inputText" name="codtypedoc" value="{{ $type_document->codtypedoc }}">
            </div>
          </div>
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-4 col-form-label">Libellé </label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputText" name="libtypedoc" value="{{ $type_document->libtypedoc }}">
              </div>
            </div>
            <div class="text-end">
